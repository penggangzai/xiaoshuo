        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            @foreach ($data as $v)
                <tr class="danger">
                    ...
                    @endif
                    <td>
                        <a href="{{url('/exchange/exchangeselect')}}/{{$v->id}}" class="btn btn-danger btn-sm">查看用户</a>
                        <a href="{{url('/exchange/exchangesingledata')}}/{{$v->id}}" class="btn btn-primary btn-sm">编辑</a>
...
//                    console.log(phone);
            ...
            function delAjax(id, obj) {
                $.ajax({
                    type: 'get',
                    url: "{{url('/exchange/exchangedelete')}}/" + id,
            ...
            function delAjaxjy(id) {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{url('exchange/exchangestatejy')}}/" + id ,
                    dateType: 'json', // 处理返回的响应值为JSON
                    success: function (data) {
                        console.log(data);
                        if (data == 1) {
            ...
            function delAjaxjh(id) {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{url('exchange/exchangestatejh')}}/" + id ,
                    dateType: 'json', // 处理返回的响应值为JSON
                    success: function (data) {
                        console.log(data);
                        if (data == 1) {
