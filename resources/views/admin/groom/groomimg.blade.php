...
@section('link')
    <div class="container-fulid col-md-11">
        <tr>
            <td width="99%" height="20" style="font-size: 20px" align="left" valign="top">您的位置 :推荐管理&nbsp;&nbsp;>&nbsp;&nbsp;添加推荐</td>
        </tr>
                    ...
                    <table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
                        ...
                        <tr>
                            <td align="left" valign="top">
                                <form method="post" action="{{url('admin/groomadd')}}" enctype='multipart/form-data'>
                                    {{  csrf_field() }}
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                                        ...
                                        <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                                            ...
                                            <td align="left" valign="middle" class="borderright borderbottom main-for">
                                                ...
                                                <input name="" type="submit" value="提 交" class="btn btn-primary btn-lg" style="margin-right: 160px">
                                                <input name="" type="reset" value="重 置" class="btn btn-danger btn-lg"></td>
                                        </tr>
                                    </table>
                                </form>
                            </td>
