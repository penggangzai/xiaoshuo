...
@section('ind')
    @parent
<link rel="shortcut icon" href="{{url('alert/favicon.ico')}}">
<link href="{{url('alert/css/style.css?v=4.1.0')}}" rel="stylesheet">
@endsection
@section('link')
                        ...
                        <div class="row row-sm text-center">
                            <div class="col-xs-6">
                                <div class="panel padder-v item">
                                    <div class="h1 text-info font-thin h1">439</div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item bg-info">
                                    <div class="h1 text-fff font-thin h1">888</div>
                            ...
                            <div class="col-xs-6">
                                <div class="panel padder-v item bg-primary">
                                    <div class="h1 text-fff font-thin h1">501</div>
                                    <span class="text-muted text-xs">书籍数量</span>
                                    <div class="top text-right w-full">
                                        <i class="fa fa-caret-down text-warning m-r-sm"></i>
                                    </div>
                                </div>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content" style="border-top:none;background-color:#e4eaec;">
                                ...
                                <div class="progress progress-striped active">
                                    <div style="width: 55%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar">
                                        <span class="sr-only"></span>
                                    </div>
                                </div>
                                <h5>流失作家</h5>
                                <div class="progress progress-striped active">
                                    <div style="width: 15%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar progress-bar-warning">
                                        <span class="sr-only"></span>
                                    </div>
                                </div>
                                <h5>新增会员</h5>
                                <div class="progress progress-striped active">
                                    <div style="width: 65%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar .progress-bar-danger">
                                        <span class="sr-only"></span>
                                    </div>
                                </div>
                                <h5>流失会员</h5>
                                <div class="progress progress-striped active">
                                    <div style="width: 25%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" role="progressbar" class="progress-bar progress-bar-info">
                                        <span class="sr-only"></span>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="{{url('alert/js/plugins/flot/jquery.flot.js')}}"></script>
    <!--flotdemo-->
