    ...
    <table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
        ...
        <tr>
            <td align="left" valign="top">
                <form method="post" action="{{url('/admin/role/insert')}}" name="regiForm" onsubmit="return ckForm()" enctype="multipart/form-data">
                    {{  csrf_field() }}
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab" >
                        <tr >
                            ...
                            <td align="left" valign="middle" class="borderright borderbottom main-for">
                                <input type="text" name="duty" class="text-word" onblur="ckUser()" value="{{old('duty')}}">
                            </td>
                            <td id="utab"></td>
                        </tr>
                        <tr >
                            ...
                            <td align="left" valign="middle" class="borderright borderbottom main-for">
                                <textarea class="form-control text-word" rows="5" name="desc" style="width: 310px" onblur="ckPass()" value="{{old('desc')}}"></textarea>
                            </td>
                            <td id="ptab"></td>
                        </tr>
                        <tr >
                        ...
                        <tr >
                            ...
                            @foreach($data as $v)
                                <label>
                                    <input type="checkbox" value="{{$v->id}}" name="id[]">&nbsp;&nbsp;&nbsp;{{$v->control_name}}&nbsp;&nbsp;
                                </label>
                             @endforeach
                            </td>
                        </tr>
