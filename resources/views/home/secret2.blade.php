...
<div class="wrap">
    ...
    <div class="header reg-header qidian">
        <div class="box-center">
            <div class="logo cf"><img src="{{ url('images/123.png') }}" width="50" height="50"><span class="lang">密码找回</span></div>
        </div>
    </div>
    <!-- end 头部 -->
    <!-- start 整体居中 -->
    <div class="box-center">
        ...
        <div class="reg-wrap">
            ...
            <div class="reg-step">
                ...
                <span class="lang act"><i>2</i>填写密保问题</span>
            </div>
            <div class="reg-form-wrap">
                <form method="post" action="{{url('/Secret/Zhix')}}">
                    {{  csrf_field() }}
                    <div class="reg-form-list form-list">
                        @foreach ($secrett as $v)
                        <input type="hidden" name="phonee" value="{{$v['phonee']}}">
                        <dl>
                            <dd class="top" id="phone"><em>问题:</em>
                                <input value="{{$v['phone']}}" name="phone" class="mid" type="text" id="txtphonenumber" disabled>
                            </dd>
                            <dd class="top" id="phone"><em>密保:</em>
                                <input name="secret" class="mid" type="text" placeholder="输入问题" id="txtphonenumber">
                            </dd>
                        </dl>
                        @endforeach
                        <div class="deal">
                        ...
                        <input id="btnPhoneRegister" class="red-btn go-reg" name="" type="submit" value="下一步"
                               class="text-but">
