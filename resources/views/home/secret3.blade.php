    ...
    <div class="box-center">
        ...
        <div class="reg-wrap">
            ...
            <div class="reg-step">
                ...
                <span class="lang act"><i>3</i>填写修改密码</span>
            </div>
            <div class="reg-form-wrap">
                <form method="post" action="{{url('/Secret/Zixg')}}" name="regiForm" onsubmit="return ckPass()">
                    {{  csrf_field() }}
                    <div class="reg-form-list form-list">
                        @foreach ($id as $v)
                        <input type="hidden" name="id" value="{{$v->id}}">
                        <dl>
                            <dd class="top" id="phone"><em>新密码:</em>
                                <td align="left" valign="middle" class="borderright borderbottom main-for">
                                    <input name="pwd" class="text-word" type="text" placeholder="输入密码" onblur="ckPass()">
                                </td>
                            </dd><td id="ptab">* 必填项,输入开头字母大小写6-18位的密码</td>
                        </dl>
